/**
 * v1 Admin Router — frozen API contract.
 *
 * @deprecated Use the unversioned `adminRouter` router instead.
 *
 * This router is a snapshot of the admin router at the time of versioning.
