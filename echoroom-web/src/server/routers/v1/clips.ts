/**
 * v1 Clips Router — frozen API contract.
 *
 * @deprecated Use the unversioned `clipsRouter` router instead.
 *
 * This router is a snapshot of the clips router at the time of versioning.
