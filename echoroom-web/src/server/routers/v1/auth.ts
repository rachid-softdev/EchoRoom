/**
 * v1 Auth Router — frozen API contract.
 *
 * @deprecated Use the unversioned `authRouter` router instead.
 *
 * This router is a snapshot of the auth router at the time of versioning.
