/**
 * v1 Community Router — frozen API contract.
 *
 * @deprecated Use the unversioned `communityRouter` router instead.
 *
 * This router is a snapshot of the community router at the time of versioning.
...
export const communityV1Router = router({
