/**
 * v1 Social Router — frozen API contract.
 *
 * @deprecated Use the unversioned `socialRouter` router instead.
 *
 * This router is a snapshot of the social router at the time of versioning.
