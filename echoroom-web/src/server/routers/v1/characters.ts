/**
 * v1 Characters Router — frozen API contract.
 *
 * @deprecated Use the unversioned `charactersRouter` router instead.
 *
 * This router is a snapshot of the characters router at the time of versioning.
