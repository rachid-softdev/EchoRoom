/**
 * v1 User Router — frozen API contract.
 *
 * @deprecated Use the unversioned `userRouter` router instead.
 *
 * This router is a snapshot of the user router at the time of versioning.
