        ...
        <div className="flex items-start gap-3">
          ...
          <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center shrink-0">
            {currentBadge.iconUrl ? (
              <img src={currentBadge.iconUrl} alt="" className="w-6 h-6" />
            ) : (
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold text-primary">Badge débloqué ! 🎉</p>
            <p className="text-sm font-semibold mt-0.5 truncate">{currentBadge.name}</p>
